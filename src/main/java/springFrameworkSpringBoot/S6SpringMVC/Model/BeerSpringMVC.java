 ...
 */
public class BeerSpringMVC {
    private UUID id;
    private Integer version;
    private String beerName;
    private BeerStyleSpringMVC beerStyleSpringMVC;
    private String upc;
    ...
    BeerSpringMVC(UUID id, Integer version, String beerName, BeerStyleSpringMVC beerStyleSpringMVC, String upc, Integer quantityOnHand, BigDecimal price, LocalDateTime createdDate, LocalDateTime updateDate) {
        this.id = id;
        this.version = version;
        this.beerName = beerName;
        this.beerStyleSpringMVC = beerStyleSpringMVC;
        this.upc = upc;
    ...
    public BeerStyleSpringMVC getBeerStyle() {
        return this.beerStyleSpringMVC;
    }
    ...
    public void setBeerStyle(BeerStyleSpringMVC beerStyleSpringMVC) {
        this.beerStyleSpringMVC = beerStyleSpringMVC;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BeerSpringMVC)) return false;
        final BeerSpringMVC other = (BeerSpringMVC) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BeerSpringMVC;
    }
    ...
    public static class BeerBuilder {
        ...
        public BeerBuilder beerStyle(BeerStyleSpringMVC beerStyleSpringMVC) {
            this.beerStyleSpringMVC = beerStyleSpringMVC;
            return this;
        }
        ...
        public BeerSpringMVC build() {
            return new BeerSpringMVC(id, version, beerName, beerStyleSpringMVC, upc, quantityOnHand, price, createdDate, updateDate);
        }

        public String toString() {
            return "Beer.BeerBuilder(id=" + this.id + ", version=" + this.version + ", beerName=" + this.beerName + ", beerStyle=" + this.beerStyleSpringMVC + ", upc=" + this.upc + ", quantityOnHand=" + this.quantityOnHand + ", price=" + this.price + ", createdDate=" + this.createdDate + ", updateDate=" + this.updateDate + ")";
        }
    }
}